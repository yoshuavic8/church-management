...
import CellGroupDetailsForm, { BaseAttendanceFormProps } from './BaseAttendanceForm';

type CellGroupAttendanceFormProps = BaseAttendanceFormProps & {
  participants: any[];
  handleParticipantStatusChange: (memberId: string, status: string) => void;
};

export default function CellGroupAttendanceForm({
  participants,
  ...
  return (
    <>
      <CellGroupDetailsForm {...baseProps} />
